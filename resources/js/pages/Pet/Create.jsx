    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error.response?.data?.errors) {
                ...
                alert('Erro ao criar pet. Tente novamente.');
            }
        } finally {
            setLoading(false);
        }
            ...
            <div className="max-w-2xl mx-auto">
                <div className="mb-6">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">Novo Pet</h2>
                            <p className="text-gray-600">Cadastre um novo animal na clínica</p>
                        </div>
                    </div>
                </div>
