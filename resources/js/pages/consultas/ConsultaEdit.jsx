...
export default function ConsultaEdit({ consultaId, onBack, onConsultaUpdated }) {
  ...
  const loadConsulta = async () => {
    try {
      ...
      if (consulta.procedures) {
        setSelectedProcedures(consulta.procedures.map(proc => ({
          id: proc.id,
          quantidade: proc.pivot.quantidade,
          valor_unitario: proc.pivot.valor_unitario,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.put(`/consultas/${consultaId}`, submitData);
      onConsultaUpdated();
    } catch (error) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edite os dados básicos da consulta
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edite os procedimentos realizados durante a consulta
            </CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            ...
                            if (selectedProc && !procedure.valor_unitario) {
